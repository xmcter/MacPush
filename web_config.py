...
DATA_DIR = os.path.expanduser("~/Library/Application Support/MacPush")
...
class ConfigServerHandler(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path == "/api/config":
            ...
            agent_path = os.path.expanduser("~/Library/LaunchAgents/com.a123.macpush.app.plist")
        ...
        if self.path == "/api/config":
            try:
                ...
                if auto_launch:
                    ...
                    plist_content = {
                        "Label": "com.a123.macpush.app",
                        "ProgramArguments": [ "/Applications/MacPush.app/Contents/MacOS/MacPush" ],
                        "RunAtLoad": True
                    }
